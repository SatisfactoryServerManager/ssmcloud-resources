...
const file_agent_config_service_proto_rawDesc = "" +
	"\n" +
	"\x1aagent_config_service.proto\x1a\vempty.proto\"a\n" +
	"\vAgentConfig\x12&\n" +
	...
	"\x02ip\x18\x03 \x01(\tR\x02ip2\x85\x01\n" +
	"\x12AgentConfigService\x12.\n" +
	"\x0eGetAgentConfig\x12\x06.Empty\x1a\x14.AgentConfigResponse\x12?\n" +
	"\x1aUpdateAgentConfigVersionIp\x12\x19.UpdateAgentConfigRequest\x1a\x06.EmptyB?Z=github.com/SatisfactoryServerManager/ssmcloud-resources/protob\x06proto3"
...
var file_agent_config_service_proto_depIdxs = []int32{
	...
	4, // 2: AgentConfigService.GetAgentConfig:input_type -> Empty
	...
	4, // 5: AgentConfigService.UpdateAgentConfigVersionIp:output_type -> Empty
