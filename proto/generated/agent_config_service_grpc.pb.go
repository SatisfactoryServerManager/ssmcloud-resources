...
type AgentConfigServiceClient interface {
	GetAgentConfig(ctx context.Context, in *models.SSMEmpty, opts ...grpc.CallOption) (*AgentConfigResponse, error)
	UpdateAgentConfigVersionIp(ctx context.Context, in *UpdateAgentConfigRequest, opts ...grpc.CallOption) (*models.SSMEmpty, error)
}
...
func (c *agentConfigServiceClient) GetAgentConfig(ctx context.Context, in *models.SSMEmpty, opts ...grpc.CallOption) (*AgentConfigResponse, error) {
...
func (c *agentConfigServiceClient) UpdateAgentConfigVersionIp(ctx context.Context, in *UpdateAgentConfigRequest, opts ...grpc.CallOption) (*models.SSMEmpty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AgentConfigServiceServer interface {
	GetAgentConfig(context.Context, *models.SSMEmpty) (*AgentConfigResponse, error)
	UpdateAgentConfigVersionIp(context.Context, *UpdateAgentConfigRequest) (*models.SSMEmpty, error)
...
func (UnimplementedAgentConfigServiceServer) GetAgentConfig(context.Context, *models.SSMEmpty) (*AgentConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAgentConfig not implemented")
}
func (UnimplementedAgentConfigServiceServer) UpdateAgentConfigVersionIp(context.Context, *UpdateAgentConfigRequest) (*models.SSMEmpty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateAgentConfigVersionIp not implemented")
}
...
func _AgentConfigService_GetAgentConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentConfigServiceServer).GetAgentConfig(ctx, req.(*models.SSMEmpty))
	}
