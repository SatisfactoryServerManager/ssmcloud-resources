...
type AgentModConfigServiceClient interface {
	GetModConfig(ctx context.Context, in *models.SSMEmpty, opts ...grpc.CallOption) (*AgentModConfigResponse, error)
	UpdateModConfig(ctx context.Context, in *AgentModConfigRequest, opts ...grpc.CallOption) (*models.SSMEmpty, error)
}
...
func (c *agentModConfigServiceClient) GetModConfig(ctx context.Context, in *models.SSMEmpty, opts ...grpc.CallOption) (*AgentModConfigResponse, error) {
...
func (c *agentModConfigServiceClient) UpdateModConfig(ctx context.Context, in *AgentModConfigRequest, opts ...grpc.CallOption) (*models.SSMEmpty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AgentModConfigServiceServer interface {
	GetModConfig(context.Context, *models.SSMEmpty) (*AgentModConfigResponse, error)
	UpdateModConfig(context.Context, *AgentModConfigRequest) (*models.SSMEmpty, error)
...
func (UnimplementedAgentModConfigServiceServer) GetModConfig(context.Context, *models.SSMEmpty) (*AgentModConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetModConfig not implemented")
}
func (UnimplementedAgentModConfigServiceServer) UpdateModConfig(context.Context, *AgentModConfigRequest) (*models.SSMEmpty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateModConfig not implemented")
}
...
func RegisterAgentModConfigServiceServer(s grpc.ServiceRegistrar, srv AgentModConfigServiceServer) {
	// If the following call panics, it indicates UnimplementedAgentModConfigServiceServer was
...
func _AgentModConfigService_GetModConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentModConfigServiceServer).GetModConfig(ctx, req.(*models.SSMEmpty))
	}
